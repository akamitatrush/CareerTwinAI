...
export const EVENTS = {
  ...
  // === Onboarding conversacional (alternativa "Prefiro conversar")
  // STARTED: user clicou na tab e chat montou. COMPLETED: respondeu
  // todas as perguntas e CV foi devolvido. MODE_SWITCHED: trocou de
  // tab (paste <-> chat) — props.from indica origem.
  ONBOARDING_CHAT_STARTED: "onboarding_chat_started",
  ONBOARDING_CHAT_COMPLETED: "onboarding_chat_completed",
  ONBOARDING_MODE_SWITCHED: "onboarding_mode_switched",
