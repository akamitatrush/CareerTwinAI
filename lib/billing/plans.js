...
export const PLANS = {
  free: {
    ...
    stripePriceId: null,
    interval: null,
    // Limites generosos durante validacao (pre-revenue). Quando atingir
    // ~100 users e tiver dado real de comportamento, ajusta pra forcar upgrade.
    limits: {
      analyze: 10, // por mes (era 3 — muito apertado pra validacao)
      tailor: 5, // por mes (era 1)
      opportunities: 20, // por dia (era 5)
      interview: 10, // por mes (era 5)
    },
    features: {
      priorityLLM: false,
      noBranding: false,
