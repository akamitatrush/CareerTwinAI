    ...
    <tr><td align="center" style="padding:32px 16px;">
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;width:100%;">
        <tr><td>
          ...
          <div style="font:11px/1 'Courier New',monospace;letter-spacing:.16em;text-transform:uppercase;color:#6B6B66;margin-bottom:24px;">BRIEFING DIARIO · ${new Date().toLocaleDateString("pt-BR")}</div>
