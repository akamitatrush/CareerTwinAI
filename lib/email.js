      ...
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;width:100%;">
        <tr><td>
          ...
          <p style="font:13px/1.5 'Helvetica Neue',sans-serif;color:#4C5048;margin-top:32px;">
            <a href="${process.env.AUTH_URL || "http://localhost:3000"}/candidaturas" style="color:#0F0F0E;">Abrir candidaturas</a> ·
            <a href="${process.env.AUTH_URL || "http://localhost:3000"}/meus-dados" style="color:#0F0F0E;">Desativar digest</a>
          </p>
